...
/*
 * Mods Screen -- allows the user to enable/disable installed modules
 * and change their load order.
 *
 */

#ifndef MODS_SCREEN_HPP
#define MODS_SCREEN_HPP

#include "screen.hpp"

class ModsScreenImpl;
