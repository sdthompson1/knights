...
public:
    KeyboardController(bool using_action_bar_,
                       Coercri::Scancode up_key_, Coercri::Scancode right_key_, Coercri::Scancode down_key_,
                       Coercri::Scancode left_key_, Coercri::Scancode fire_key_, Coercri::Scancode suicide_key_,
