...
messages = {
   ...
   [3] = {
      title = "LOCKED DOOR",
      graphics = {C.g_door_hic, C.g_hdoor_background},
   ...
   [5] = { 
      ...
      body = "Your knight starts out carrying a sword, but you can find other weapons (like this hammer). "..
         "When you take another weapon, your sword will be sheathed temporarily. When you drop the hammer, "..
         "your knight will revert to using the sword.\n\n"..
   ...
   [6] = {
      ...
      body = "Excellent, you are now carrying the hammer. Right-click to swing it, or left-click again to drop it.\n\n"..
         "The hammer is the slowest weapon, but also the most powerful. A hammer can destroy any wooden "..
   ...
   [8] = {
      ...
      body = "By now, you will have noticed the mini-map in the bottom right hand corner. "..
         ...
         "until the enemy has left.\n\n"..
         "Also, certain magical scrolls may give you a complete map of the "..
         "dungeon, or even wipe your map completely.\n\n"..
         "Now, onwards..."
   },
   ...
   [12] = {
      ...
      body = "This is a dungeon entrance. Each knight will have their own separate entry point, "..
         ...
         "Since this is not your own entry point, there is nothing you can do here. You need to find five "..
         "gems, then return to your own entry point (at the top of the map)."
   },

   [13] = {
      title = "SWITCH ROOM",
      graphics = {C.g_switch_up},
      body = "Hmm, this looks interesting.\n\n"..
         "It looks like you need to pull those levers at the top of the room, "..
         "but the closed gates are blocking your way.\n\n"..
         "See if you can find a way to open them."
   },
   ...
   [14] = {
      ...
      body = "Well done, you have reached the first lever.\n\n"..
         "To pull it, push %U to move towards the lever, then (while still holding down the %U key) "..
   ...
   [16] = {
      ...
      body = "That's it! Both gates are now open and you can reach the first gem!\n\n"..
         "Now make your way to the top right hand corner of the room, and pick up the gem."
   },

   [17] = {
      title = "GATE CLOSED!",
      graphics = {C.g_hdoor_background, C.g_door_hgc},
      body = "Oh no! The gate has closed behind us! We now have no choice but to move on...\n\n"..
   ...
   [18] = {
      title = "GEM",
      graphics = {C.g_floor1, C.g_gem},
      body = "Congratulations, you now have one gem. Notice how an icon has appeared below "..
         "the mini-map to let you know you are carrying it.\n\n"..
         "If you want to drop the gem, you can do so by clicking the \"Drop Gem\" icon on the "..
         "Action Bar (fourth one from the right). You won't need to do that in this Tutorial, "..
         "but in a multiplayer game it can sometimes be useful to hide gems in secret places, "..
         "so that your opponents can't find them.\n\n"..
         "Now continue exploring the dungeon. We still need four more gems before we can complete "..
         "the quest!"
   },
   ...
   [22] = {
      ...
      body = "Argh, you fell into a Bottomless Pit!\n\n"..
         ...
         "where you died. So make sure you go back and pick up your gems again before continuing..."
   },

   [23] = {
      title = "GEM",
      graphics = {C.g_table_small, C.g_gem},
      body = "Another gem! This one is on a table.\n\n"..
         "Picking up items from tables is easy. First, stand next to the table. Then, \"approach\" the table "..
         "by moving your knight towards it. "..
         "Finally, while still holding down the movement key, click the left mouse button."
   },

   [24] = {
      {
         title = "VAMPIRE BAT",
         body = "There is a vampire bat in this room. Bats are dangerous; their sharp teeth can "..
            "pierce even a knight's plate armour. Luckily this one is caged, although flipping that "..
            "lever will release it.",
         popup = true
      },

      {
         title = "WEAPONS",
         body = "Generally, the sword is the best choice of weapon for bat-killing, because of its speed.\n\n"..
            "If you are still carrying your hammer, you may want to drop it (left-click) as it will "..
            "be difficult to kill bats with such a slow weapon.",
         popup = true
      },

      {
         title = "COMBAT (3/3)",
         body = "Finally, observe the Potion Bottle at the lower left of your screen. This indicates your "..
            "own health level. At the moment, it is full. If you take hits, it will decrease; when it empties, "..
            "you will die.",
         popup = true
      },

      {
         ...
         body = "Now pull the lever to release the bat. Then turn to face the bat, and right-click to kill it.\n\n"..
            "Remember: keep calm and don't panic. Time your blows carefully and you should have no problems."
      }
   },
   ...
   [26] = {
      ...
      body = "Ah, this is the Chamber of Vampire Bats. Not a pleasant place for a knight, I can tell you.\n\n"..
         "Now, listen carefully. Once you pull the lever at the bottom of this room, bats will start appearing from "..
         "the holes in the floor. Your mission is to kill five bats, before they kill you. Good luck...\n\n"..
         "(Remember, to pull the lever, you must approach it, then, while still holding down the movement key, "..
         "click the left mouse button.)"
   },
   ...
   [29] = {
      ...
      graphics = {C.g_wooden_floor, C.g_vbat_1},
      body = "Pull the lever and have another go."
   },
   ...
   [31] = {
      title = "MISSION FAILED",
      graphics = {C.g_wooden_floor, C.g_vbat_1},
      body = "You seem to be having some trouble with this, so we will let you "..
         "skip this area if you want. Just go through the doors at the left and right, "..
         "which are now open.\n\n"..
         "If you want to try again, then just pull the lever once more."
   },

   [32] = {
      title = "CHAMBER OF BATS - LEVEL 2",
      graphics = {C.g_wooden_floor, C.g_vbat_1},
      body = "Oh so you want more, do you? Very well, let's make this a bit more interesting. Bats "..
   ...
   [38] = {
      title = "KEY",
      graphics = {C.g_small_table, C.g_key},
      body = "Ah, a key. I wonder what it unlocks?\n\n"..
         "The key is on a table. To pick it up, you must first approach the table, then left-click the mouse "..
         "(while still holding the movement key)."
   },
   ...
   [39] = {
      ...
      body = "Key collected.\n\n"..
         ...
         "set of locks. There will also be a set of lock picks, which can be used to open most locks "..
   ...
   [40] = {
      ...
      body = "This room contains three treasure chests.\n\n"..
         "You can open a chest in the same way that you would open a door (in other words, by approaching it "..
         "and then left-clicking the mouse)."
   },
   ...
   [41] = {
      ...
      body = "This chest contains a magic potion. Potions have various effects -- most helpful, but some harmful. "..
         ...
         "(Reminder: To pick up items from chests, just "..
         "left-click the mouse while you are approaching the chest."
   },
   ...
   [44] = {
      ...
      body = "Did I tell you that some chests are trapped?\n\n"..
         "Ah well, I must have forgotten to mention it.\n\n"..
         "This chest had a bolt trap that fired when you opened the chest. You have taken some damage.\n\n"..
         "There are ways to avoid traps, we will discuss that a little later in the Tutorial."
   },
   ...
   [45] = {
      ...
      body = "Pentagrams contain powerful, if rather dangerous magic. They can grant invisibility or "..
         "invulnerability, teleport you next to another knight, or even turn you into a zombie.\n\n"..
   ...
   [49] = {
      title = "SKULL ROOM",
      graphics = {C.g_skull_east},
      body = "Hmm, those skulls look dangerous..."
   },
   ...
   [51] = {
      ...
      graphics = {C.g_floorpp, C.g_stuff_bag},
   ...
   [54] = {
      title = "LOCK PICKS",
      graphics = {C.g_lockpicks},
      body = "On closer inspection, you find that this is actually a set of lock picks.\n\n"..
         "To use, you need to approach a locked door or chest, then click the \"Pick Lock\" icon on the Action Bar. "..
   ...
   [55] = {
      ...
      body = "This is an axe. Left-click (while standing on it) to pick it up.\n\n"..
         ...
         "or used to smash wooden objects (you will need to hit them a few times though).\n\n"..
   ...
   [56] = {
      ...
      body = "This room contains a crossbow and bolts. The crossbow is a powerful weapon -- if it is loaded.\n\n"..
         "To try out the crossbow, first pick it up, along with the bolts. Then stand still, and your knight "..
         ...
         "After the crossbow is fired, you will need to reload it before you can fire again.\n\n"..
         "A crossbow is useless without bolts, and vice versa."
   },
   ...
   [57] = {
      ...
      body = "This is a crystal ball. It can be used to find out the location of other knights in the dungeon.\n\n"..
         "To use a crystal ball you just walk up to it; all the time you are holding down the movement key, the "..
         "locations of other knights will be revealed on your mini-map.\n\n"..
   ...
   [58] = {
      title = "SCROLL",
      graphics = {C.g_scroll},
      body = "This is a magical scroll. Like potions, scrolls can have various "..
   ...
   [60] = {
      title = "REGENERATION",
      graphics = {C.g_chest_north, C.g_potion},
   ...
   [61] = {
      ...
      body = "Oh dear, that potion was poisonous.\n\n"..
         "In general, ost potions are helpful, but you will occasionally find potions of poison or paralysis.\n\n"..
         "Also, if you are lucky enough to find a potion of poison immunity, then this will make "..
         "further potion drinking completely safe (as well as making you immune to poison traps)."
   },
   ...
   [62] = {
      ...
      body = "Just like doors, chests will sometimes be locked.\n\n"..
         "Since you don't have a key, you could try to break into the chest by using a hammer or axe "..
         "(or even your sword, if you "..
         "are very patient). However, smashing a chest will destroy any potions inside "..
         "(other objects will survive though).\n\n"..
         "Alternatively, if you have lock picks you could try to pick the lock. Simply hold down the "..
         "\"Pick Lock\" icon on the Action Bar, until the chest opens. (This may take some time.)" 
   },

   [64] = {
      title = "TRAPS",
      graphics = {C.g_floor1, C.g_bear_trap_closed},
   ...
   [67] = {
      ...
      body = "It looks like a knight died here, and left some stuff behind. Make sure you pick up "..
   ...
   [73] = {
      ...
      graphics = {C.g_floor1, C.g_poison_trap},
   ...
   [74] = {
      ...
      graphics = {C.g_floor1, C.g_blade_trap},
...
stuff_msg = "Excellent, the bag contained a gem!\n\n"
...
bat_mission_text = "Your mission is to kill %d bats.\n\nGame on!"
...
bat_success_text = "Mission completed successfully. Well done."
