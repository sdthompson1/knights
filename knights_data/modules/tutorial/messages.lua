...
messages = {
   ...
   [2] = {
      title = "DOORS",
      graphics = {B.g_hdoor_background, B.g_door_hwc},
   ...
   [3] = {
      title = "LOCKED DOOR",
      graphics = {B.g_hdoor_background, B.g_door_hic},
   ...
   [5] = { 
      title = "HAMMER",
      graphics = {B.g_floor1, B.g_hammer},
   ...
   [9] = {
      title = "LOCKED DOOR",
      graphics = {B.g_vdoor_background, B.g_door_vwc},
   ...
   [17] = {
      title = "GATE CLOSED!",
      graphics = {B.g_hdoor_background, B.g_door_hgc},
   ...
   [23] = {
      title = "GEM",
      graphics = {B.g_table_south, B.g_gem},
   ...
   [24] = {
      ...
      {
         title = "VAMPIRE BAT",
         graphics = {B.g_floor1, B.g_vbat_1},
   ...
   [38] = {
      title = "KEY",
      graphics = {B.g_table_small, B.g_key},
   ...
   [41] = {
      title = "POTION",
      graphics = {B.g_open_chest_north, B.g_potion},
   ...
   [43] = {
      title = "GEM",
      graphics = {B.g_open_chest_north, B.g_gem},
   ...
   [51] = {
      ...
      graphics = {B.g_pressure_plate, B.g_stuff_bag},
   ...
   [56] = {
      ...
      graphics = {B.g_floor1, B.g_crossbow},
   ...
   [58] = {
      title = "SCROLL",
      graphics = {B.g_floor1, B.g_scroll},
   ...
   [64] = {
      title = "TRAPS",
      graphics = {B.g_floor1, B.g_closed_bear_trap},
   ...
   [66] = {
      ...
      graphics = {B.g_floor1, B.g_daggers},
   ...
   [67] = {
      title = "STUFF BAG",
      graphics = {B.g_floor1, B.g_stuff_bag},
   ...
   [79] = {
      title = "DEATH",
      graphics = {B.g_dead_knight_1, B.g_stuff_bag},
