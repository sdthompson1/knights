...
install_knights: $(KNIGHTS_BINARY_NAME)
	...
	$(INSTALL) -m 644 knights_data/server/main_tutorial.lua $(DATA_DIR)
	...
	$(INSTALL) -m 644 knights_data/server/tutorial/init.lua $(DATA_DIR)
	$(INSTALL) -m 644 knights_data/server/tutorial/messages.lua $(DATA_DIR)
	$(INSTALL) -m 644 knights_data/server/tutorial/tutorial_map.txt $(DATA_DIR)
...
uninstall:
	...
	rm -f $(DATA_DIR)/main_tutorial.lua
	...
	rm -f $(DATA_DIR)/init.lua
	rm -f $(DATA_DIR)/init.lua
	rm -f $(DATA_DIR)/messages.lua
	rm -f $(DATA_DIR)/tutorial_map.txt
