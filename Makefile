...
install_knights: $(KNIGHTS_BINARY_NAME)
	...
	$(INSTALL) -m 644 knights_data/server/menu/init.lua $(DATA_DIR)
	$(INSTALL) -m 644 knights_data/server/multiwand/init.lua $(DATA_DIR)
	$(INSTALL) -m 644 knights_data/server/multiwand/wands/deat.bmp $(DATA_DIR)
	$(INSTALL) -m 644 knights_data/server/multiwand/wands/deat_east.bmp $(DATA_DIR)
	$(INSTALL) -m 644 knights_data/server/multiwand/wands/deat_north.bmp $(DATA_DIR)
	$(INSTALL) -m 644 knights_data/server/multiwand/wands/deat_south.bmp $(DATA_DIR)
	$(INSTALL) -m 644 knights_data/server/multiwand/wands/deat_west.bmp $(DATA_DIR)
	$(INSTALL) -m 644 knights_data/server/multiwand/wands/dest.bmp $(DATA_DIR)
	$(INSTALL) -m 644 knights_data/server/multiwand/wands/dest_east.bmp $(DATA_DIR)
	$(INSTALL) -m 644 knights_data/server/multiwand/wands/dest_north.bmp $(DATA_DIR)
	$(INSTALL) -m 644 knights_data/server/multiwand/wands/dest_south.bmp $(DATA_DIR)
	$(INSTALL) -m 644 knights_data/server/multiwand/wands/dest_west.bmp $(DATA_DIR)
	$(INSTALL) -m 644 knights_data/server/multiwand/wands/open.bmp $(DATA_DIR)
	$(INSTALL) -m 644 knights_data/server/multiwand/wands/open_east.bmp $(DATA_DIR)
	$(INSTALL) -m 644 knights_data/server/multiwand/wands/open_north.bmp $(DATA_DIR)
	$(INSTALL) -m 644 knights_data/server/multiwand/wands/open_south.bmp $(DATA_DIR)
	$(INSTALL) -m 644 knights_data/server/multiwand/wands/open_west.bmp $(DATA_DIR)
	$(INSTALL) -m 644 knights_data/server/multiwand/wands/secu.bmp $(DATA_DIR)
	$(INSTALL) -m 644 knights_data/server/multiwand/wands/secu_east.bmp $(DATA_DIR)
	$(INSTALL) -m 644 knights_data/server/multiwand/wands/secu_north.bmp $(DATA_DIR)
	$(INSTALL) -m 644 knights_data/server/multiwand/wands/secu_south.bmp $(DATA_DIR)
	$(INSTALL) -m 644 knights_data/server/multiwand/wands/secu_west.bmp $(DATA_DIR)
	$(INSTALL) -m 644 knights_data/server/multiwand/wands/version.txt $(DATA_DIR)
...
uninstall:
	...
	rm -f $(DATA_DIR)/init.lua
	rm -f $(DATA_DIR)/init.lua
	rm -f $(DATA_DIR)/deat.bmp
	rm -f $(DATA_DIR)/deat_east.bmp
	rm -f $(DATA_DIR)/deat_north.bmp
	rm -f $(DATA_DIR)/deat_south.bmp
	rm -f $(DATA_DIR)/deat_west.bmp
	rm -f $(DATA_DIR)/dest.bmp
	rm -f $(DATA_DIR)/dest_east.bmp
	rm -f $(DATA_DIR)/dest_north.bmp
	rm -f $(DATA_DIR)/dest_south.bmp
	rm -f $(DATA_DIR)/dest_west.bmp
	rm -f $(DATA_DIR)/open.bmp
	rm -f $(DATA_DIR)/open_east.bmp
	rm -f $(DATA_DIR)/open_north.bmp
	rm -f $(DATA_DIR)/open_south.bmp
	rm -f $(DATA_DIR)/open_west.bmp
	rm -f $(DATA_DIR)/secu.bmp
	rm -f $(DATA_DIR)/secu_east.bmp
	rm -f $(DATA_DIR)/secu_north.bmp
	rm -f $(DATA_DIR)/secu_south.bmp
	rm -f $(DATA_DIR)/secu_west.bmp
	rm -f $(DATA_DIR)/version.txt
